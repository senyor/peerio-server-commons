...
module.exports = {
    newId() {
        ...
        return [Date.now().toString(36), cutToLength(process.pid.toString(36), 4), millisCount.toString(36), chars.charAt(_.random(chars.length - 1)), chars.charAt(_.random(chars.length - 1))].join(''); // eslint-disable-line
    }
};
